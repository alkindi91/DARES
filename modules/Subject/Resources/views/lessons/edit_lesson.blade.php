...
@section('content')
{!! Form::open(['route'=>['subject.update_lesson', $tasks->id],'class'=>'form-horizontal form-label-left'])!!}
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Form::text('order' ,$tasks->order,['class'=>'form-control']) !!}
        </div>
    </div>
    <div class="form-group">
        {!! Form::label('type', 'النوع', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')) !!}
        <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Form::text('type' ,$tasks->type,['class'=>'form-control']) !!}
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <i class="fa fa-save"></i> @lang('global.update')</button>
        </div>
    </div>
{!!Form::close()!!}
@stop