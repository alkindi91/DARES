...
class Department extends Model {
	...
	{
		$query->selectRaw('academystructure_departments.id as did, as.id as sid, af.id as fid, ay.id as yid,at.id as tid,
						   as.name as sname ,at.name as tname,ay.name as yname,af.name as fname')
