...
Route::group(['prefix' => 'academystructure', 'namespace' => 'Modules\Academystructure\Http\Controllers'], function()
{
	...
	Route::get('edit/{faculty}', ['as' =>'faculty.edit', 'uses' =>'FacultyController@edit_faculty']);
	post('update/{faculty}', ['as' =>'faculty.update', 'uses' =>'FacultyController@update_faculty']);
	
	Route::get('delete/{faculty}', ['as' =>'faculty.delete', 'uses' =>'FacultyController@delete_faculty']);
	////////////////////Year///////////////////////////
});