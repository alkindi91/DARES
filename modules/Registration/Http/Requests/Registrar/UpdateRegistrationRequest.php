...
class UpdateRegistrationRequest extends FormRequest {
	...
	public function rules()
	{
		...
		return [
				...
				'passeport_country_id'  =>'exists:lists_countries,id|required_with:passeport_number',
				...
				'contact_email'         =>'required|unique:registrations,contact_email,'.$registration_id.'|max:255',
				...
				'social_job'            =>'required',
				'social_job_status'     =>'required_if:social_job,employed',
				'social_job_start'      =>'required_if:social_job,employed',
				'social_experience'     =>'required_if:social_job,employed',
				'social_job_employer'   =>'required_if:social_job,employed',
				'social_job_country_id'	=>'required_if:social_job,employed|exists:lists_countries,id',
				'social_job_city_id'  	=>'required_if:social_job,employed|exists:lists_cities,id',
