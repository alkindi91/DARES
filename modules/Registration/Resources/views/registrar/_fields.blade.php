...
<div class='x_panel panel-primary'>
				...
				<div class="row">
					<div class="col-sm-6 col-xs-12">
						<div class="form-group">
							...
							<label>
								ذكر : {!! Form::radio('gender' ,"m",null ,['class'=>'flat', 'id'=>'genderM', 'required'=>'required']) !!}
								
							</label>
							<label>
								أنثى : {!! Form::radio('gender' ,"f",null ,['class'=>'flat', 'id'=>'genderF', 'required'=>'required']) !!}
							</label>
						</div>
					</div>
					<div class="col-sm-6 col-xs-12">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<label>
								عماني : {!! Form::radio('nationality_type' ,"omani" ,null ,['class'=>'flat','required'=>'required']) !!}
							</label>
							<label>
								غير عماني : {!! Form::radio('nationality_type' ,"expat" ,null ,['class'=>'flat','required'=>'required']) !!}
							</label>
						</div>
					</div>
				</div>
				...
				<div class="row registration-form__nationality omani" id='expactId'>
					...
					<div class="col-sm-4 col-xs-12">
						<div class="form-group">
							...
							{!! Form::select('birth_country_id' ,$countries_list ,null ,['data-parsley-errors-container'=>"#birthCountryContainer",'class'=>'select2_single form-control' ,'id'=>'birth_country_id','required'=>'required']) !!}
							<div id="birthCountryContainer"></div>
						</div>
					</div>
					<div class="col-sm-4 col-xs-12 omani">
						<div class="form-group">
							<label for="nationality_city_id">
								المحافظة :
							</label>
							
							{!! Form::select('nationality_city_id' ,(isset($registration) and !empty($nationality_cities = $registration->birthcountry->cities->lists('name', 'id')->toArray())) ? $nationality_cities : [] ,null ,['data-parsley-errors-container'=>"#birthCityContainer",'class'=>'select2_single form-control' ,'id'=>'nationality_city_id']) !!}
							<div id="birthCityContainer"></div>
						</div>
					</div>
					<div class="col-sm-4 col-xs-12 omani">
						<div class="form-group">
							<label for="nationality_state_id">
								الولاية :
							</label>
					...
					<div class="col-sm-6 col-xs-12">
						<div class="form-group">
							...
							<label>
								...
								مسلم : {!! Form::radio('religion' ,"muslim" ,null ,['class'=>'flat','id'=>'religionM','required'=>'required']) !!}
								
							</label>
							<label>
								مسيحي : {!! Form::radio('religion' ,"christian" ,null ,['class'=>'flat','id'=>'religionC','required'=>'required']) !!}
								
							</label>
							<label>
								يهودي : {!! Form::radio('religion' ,"jew" ,null ,['class'=>'flat','id'=>'religionJ','required'=>'required']) !!}
							</label>
						</div>
					</div>
		...
		<div class="x_panel panel-primary">
			...
			<div class="x_content js-social-country">
				<div class="clearfix"></div>
				<div class="row">
					<div class="col-sm-3 col-xs-12">
						<div class="form-group">
							...
							{!! Form::select('contact_country_id' ,$countries_list ,null ,['data-parsley-errors-container'=>"#contactCountryErrors",'class'=>'select2_single form-control' ,'id'=>'contact_country_id']) !!}
							<div id="contactCountryErrors"></div>
						</div>
					</div>
					<div class="col-sm-3 col-xs-12">
						<div class="form-group">
							<label for="contact_city_id">
								المحافظة <i class="fa text-danger fa-asterisk"></i>:
							</label>
							
							{!! Form::select('contact_city_id' ,(isset($registration) and !empty($contact_cities = $registration->contactcountry->cities->lists('name', 'id')->toArray())) ? $contact_cities : [] ,null ,['data-parsley-errors-container'=>"#contactCityErrors",'class'=>'select2_single form-control' ,'id'=>'contact_city_id','required'=>'required']) !!}
							<div id="contactCityErrors"></div>
						</div>
					</div>
					<div class="col-sm-3 col-xs-12">
						<div class="form-group js-social-country-required">
							<label for="contact_state_id">
								الولاية <i class="fa text-danger fa-asterisk "></i>:
							</label>
							
							{!! Form::select('contact_state_id' ,(isset($registration) and !empty($contact_states = $registration->contactcity->states->lists('name', 'id')->toArray())) ? $contact_states : [] ,null ,['data-parsley-errors-container'=>"#contactStateErrors",'class'=>' select2_single form-control' ,'id'=>'contact_state_id','required'=>'required']) !!}
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12">
						<div class="form-group">
							...
							<label>
								سليم بدنيا و صحيا :
								{!! Form::radio('health_status' ,1 ,null ,['class'=>'flat' ,'required'=>'required']) !!}
								
							</label>
							<label>
								أعاني من اعاقة : {!! Form::radio('health_status' ,0 ,null ,['class'=>'flat','required'=>'required']) !!}
							</label>
						</div>
					</div>
					<div class="col-sm-4 col-xs-12 health-disabled-fields">
						<div class="form-group">
							...
							<label>
								حركية :
								{!! Form::radio('health_disabled_type' ,"mouvement" ,null ,['class'=>'flat']) !!}
					...
					<div class="col-sm-4 col-xs-12 health-disabled-fields">
						<div class="form-group">
							...
							<label>
								كلية :
								{!! Form::radio('health_disabled_size' ,"full" ,null ,['class'=>'flat']) !!}
				...
				<div class="row">
					<div class="col-xs-12 col-sm-4">
						<div class="form-group">
							...
							<label>
								يوجد :
								{!! Form::radio('internet_link' ,1 ,null ,['class'=>'flat','required'=>'required']) !!}
					...
					<div class="col-xs-12 col-sm-4">
						<div class="form-group">
							...
							<label>
								يوجد :
								{!! Form::radio('cyber_cafe' ,1 ,null ,['class'=>'flat','required'=>'required']) !!}
					...
					<div class="col-xs-12 col-sm-4">
						<div class="form-group">
							...
							<label>
								يوجد :
								{!! Form::radio('computer_availability' ,1 ,null ,['class'=>'flat','required'=>'required']) !!}
...
$('body').on('change', '#contact_country_id', function(event) {
	...
	applyFetchCities('contact_city_id' ,$this.val() ,'contact_state_id');
	changeCallingCode($this.val());
});
$('body').on('change', '#birth_country_id', function(event) {
	event.preventDefault();
	var $this = $(this);
	/* Act on the event */
...
$('body').on('change', '#contact_city_id', function(event) {
	event.preventDefault();
	/* Act on the event */
	applyFetchStates('contact_state_id' ,$(this).val());
});
